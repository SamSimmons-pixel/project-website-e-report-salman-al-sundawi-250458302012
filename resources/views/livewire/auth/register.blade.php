        <div id="auth-left">
            ...
            <form wire:submit="register">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" wire:model="name" class="form-control form-control-xl" placeholder="Username">
                    <div class="form-control-icon">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="number" wire:model="no_whatsapp" class="form-control form-control-xl" placeholder="Whatsapp Number">
                    <div class="form-control-icon">
